...
with open(file_to_save, "w") as txt_file:
    ...
    for county in countyvotes:
        ...
        countyvote = countyvotes[county]
        # 6c: Calculate the percentage of votes for the county.
        countypercent = countyvote/total_votes * 100
        countyresults = (
            f"{county}: {countypercent:.1f}% ({countyvote:,})")
         # 6d: Print the county results to the terminal.
        print(countyresults)
         # 6e: Save the county votes to a text file.
        txt_file.write(countyresults)
         # 6f: Write an if statement to determine the winning county and get its vote count.
        if countyvote > winningcountyvote:
            winningcountyvote = countyvote
            winningcounty = county
